...
const Header = () => {
  ...
  return (
    <>
      {/* Header */}
      <header className="bg-gradient-to-r from-purple-600 to-purple-700 px-4 py-3 fixed top-0 left-0 right-0 z-50">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2 flex-1 max-w-xs sm:max-w-md mx-2">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-1.5 bg-white/90 border border-gray-200 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
              />
            </div>
            ...
            <div className="relative">
              ...
              <select
                ...
                className="pl-7 pr-6 py-1.5 bg-white/90 border border-gray-200 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent appearance-none min-w-[100px] sm:min-w-[120px]"
              >
          ...
          <div className="flex items-center space-x-2">
            ...
            <Link
              to="/add"
              className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-3 py-1.5 rounded-md text-sm font-medium flex items-center space-x-1 hover:shadow-md transition-all duration-200"
            >
            ...
            {user && (
              <div className="relative">
                <button
                  ...
                  className="flex items-center space-x-1 bg-white/10 backdrop-blur-sm rounded-md px-2 py-1.5 text-white hover:bg-white/20 transition-colors"
                >
